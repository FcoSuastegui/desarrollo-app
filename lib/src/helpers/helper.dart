...
class Helper {
  ...
  static Future<Map<String, dynamic>> launchInBrowser(String url) async {
    Map<String, dynamic> response  = { 'status':  true };
      await canLaunch(url) 
      ? 
        await launch(url) 
      : response['status'] = false; response['message'] = 'No se pudo abrir el archivo';
  ...
  static Widget getCardTypeIcon({String cardNumber}) {
    ...
    switch (getCardType(cardNumber)) {
      case CardType.americanExpress:
        return Image.asset(
          "assets/card_wallet/american_express.png",
          width: 30,
          height: 30,
        );
      case CardType.dinersClub:
        return Image.asset(
          "assets/card_wallet/diners_club.png",
          width: 30,
          height: 30,
        );
      case CardType.discover:
        return Image.asset(
          "assets/card_wallet/discover.png",
          width: 70,
          height: 50,
        );
      case CardType.jcb:
        return Image.asset(
          "assets/card_wallet/jcb.png",
          width: 30,
          height: 30,
        );
      case CardType.masterCard:
        return Image.asset(
          "assets/card_wallet/master_card.png",
          width: 30,
          height: 30,
        );
      case CardType.maestro:
        return Image.asset(
          "assets/card_wallet/maestro.png",
          width: 30,
          height: 30,
        );
      case CardType.rupay:
        return Image.asset(
          "assets/card_wallet/rupay.png",
          width: 80,
          height: 50,
        );
      case CardType.visa:
        return Image.asset(
          "assets/card_wallet/visa.png",
          width: 30,
          height: 30,
        );
      default:
  ...
  static CardType getCardType(String cardNumber) {
    ...
    RegExp rMasterCard =
        new RegExp(r"^(5[1-5]|222[1-9]|22[3-9]|2[3-6]|27[01]|2730)[0-9]{0,}$");
